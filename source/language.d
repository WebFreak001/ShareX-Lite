...
static this()
{
	...
	[
		"en": Language([
			...
			"screenshot.copy.url": "URL",
			"screenshot.copy.shortened": "Shortened URL",
			"screenshot.copy.thumbnail": "Thumbnail URL",
			"screenshot.copy.deletion": "Deletion URL",
			"screenshot.copy.file": "File",
			"screenshot.copy.image": "Image",
			"screenshot.copy.text": "Text",
			"screenshot.copy.thumbnailfile": "Thumbnail File",
			"screenshot.copy.thumbnailimage": "Thumbnail Image",
			"screenshot.copy.htmllink": "HTML Link",
			"screenshot.copy.htmlimage": "HTML Image",
			"screenshot.copy.htmllinkedimage": "HTML Image Link",
			"screenshot.copy.bblink": "Forum (BBCode) Link",
			"screenshot.copy.bbimage": "Forum (BBCode) Image",
			"screenshot.copy.bblinkedimage": "Forum (BBCode) Image Link",
			"screenshot.copy.filepath": "File path",
			"screenshot.copy.filename": "File name",
			"screenshot.copy.filenamewoext": "File name without extension",
			"screenshot.copy.folder": "Folder",
